            ...
            <Container className="h-50">
                <Row className="h-100">
                    ...
                    <div className="center-buttons">
                                <Button className='header-button button-color' href="/products">Check out Products</Button>
                                <Button className="header-button-margin header-button button-color" href="/services">Browse Services</Button>
                            </div>
                    </Col>
                </Row>
            </Container>
